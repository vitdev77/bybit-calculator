...
export default function MarketTicker({
  ...
  // Скелетон при первой загрузке или принудительном рефреше данных
  if (loading || !data) {
    return (
      <div className="p-3 sm:p-4 border border-border/40 dark:border-black/40 rounded-xl bg-muted/30 dark:bg-black/40 shadow-inner grid grid-cols-2 md:grid-cols-6 gap-3 sm:gap-4 w-full items-center h-20 sm:h-22.5 select-none box-border overflow-hidden">
        <div className="flex items-center gap-3 p-0.5 md:col-span-1 border-r border-border/30 pr-1 sm:pr-2 h-12 flex-row shrink-0 min-w-fit">
          <Skeleton className="size-9 sm:size-10 rounded-full shrink-0" />
          <div className="space-y-1.5 flex-1 min-w-0">
            <Skeleton className="h-3.5 w-12 sm:w-14" />
            <Skeleton className="h-2.5 w-16 sm:w-20 opacity-60" />
          </div>
        </div>

        <div className="p-0.5 w-full md:col-span-2 h-10 sm:h-11 flex flex-col justify-center space-y-1.5">
          <Skeleton className="h-2.5 w-12 sm:w-14 ml-5 sm:ml-7 opacity-60" />
          <Skeleton className="h-5 sm:h-6 w-28 sm:w-36 ml-5 sm:ml-7" />
        </div>

        <div className="p-0.5 md:col-span-1 h-10 sm:h-11 flex flex-col justify-center space-y-1.5">
          <Skeleton className="h-2.5 w-14 sm:w-16 opacity-60" />
          <Skeleton className="h-4 w-10 sm:w-12" />
        </div>

        <div className="p-0.5 hidden sm:flex flex-col justify-center min-w-24 md:col-span-1 h-10 sm:h-11 space-y-2">
          <Skeleton className="h-2.5 w-12 opacity-60" />
          <Skeleton className="h-1.5 w-full rounded-full" />
          <div className="flex justify-between">
            <Skeleton className="h-2 w-6 opacity-40" />
            <Skeleton className="h-2 w-6 opacity-40" />
          </div>
        </div>
  ...
  return (
    <div className="p-3 sm:p-4 border border-border/40 dark:border-black/40 rounded-xl bg-muted/30 dark:bg-black/40 shadow-inner grid grid-cols-2 md:grid-cols-6 gap-3 sm:gap-4 w-full items-center h-20 sm:h-22.5 box-border overflow-hidden">
